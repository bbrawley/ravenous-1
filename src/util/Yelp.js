...
const Yelp = {
  getAccessToken() {
      if(accessToken){
         ...
         return fetch(`https://api.yelp.com/oauth2/token?grant_type=client_credentials&client_id= ${clientId} &client_secret=${secret}`.fetch(https://cors-anywhere.herokuapp.com/),
